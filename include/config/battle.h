...
#define B_SKETCH_BANS               GEN_5 // In Gen9+, Sketch is unable to copy more moves than in previous generations.
...
#define B_OBEDIENCE_MECHANICS           GEN_6_ORAS // In PLA+ (here Gen8+), obedience restrictions also apply to non-outsider Pokémon, albeit based on their level met rather than actual level
