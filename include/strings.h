...
extern const u8 gText_DefaultNameMohsen[];
extern const u8 gText_DefaultNameSina[];
extern const u8 gText_DefaultNameHossein[];
extern const u8 gText_DefaultNameAlireza[];
extern const u8 gText_DefaultNameSohrab[];
extern const u8 gText_DefaultNameArmaan[];
extern const u8 gText_DefaultNameDariush[];
extern const u8 gText_DefaultNameFarzad[]; // santonio won't fit
extern const u8 gText_DefaultNameMilad[];
extern const u8 gText_DefaultNameNima[];
extern const u8 gText_DefaultNameLeVeon[];
extern const u8 gText_DefaultNameNavid[];
extern const u8 gText_DefaultNameOmid[];
extern const u8 gText_DefaultNameAbbas[];
extern const u8 gText_DefaultNameKasey[];
extern const u8 gText_DefaultNameAsghar[];
extern const u8 gText_DefaultNameReza[];
extern const u8 gText_DefaultNameSaeed[];
extern const u8 gText_DefaultNameAfshin[];
extern const u8 gText_DefaultNameSiavash[];
extern const u8 gText_DefaultNameParvin[];
extern const u8 gText_DefaultNameShila[];
extern const u8 gText_DefaultNameMitra[];
extern const u8 gText_DefaultNameSima[];
extern const u8 gText_DefaultNameParisa[];
extern const u8 gText_DefaultNameYosi[];
extern const u8 gText_DefaultNameShohreh[];
extern const u8 gText_DefaultNameKimia[];
extern const u8 gText_DefaultNameBahar[];
extern const u8 gText_DefaultNameShadi[];
extern const u8 gText_DefaultNameMelody[];
extern const u8 gText_DefaultNameShirin[];
extern const u8 gText_DefaultNameNazanin[];
extern const u8 gText_DefaultNameNika[];
extern const u8 gText_DefaultNameElaheh[];
extern const u8 gText_DefaultNameNasrin[];
extern const u8 gText_DefaultNameZahra[]; // nastaran won't fit
extern const u8 gText_DefaultNameNoushin[];
extern const u8 gText_DefaultNameSamira[];
extern const u8 gText_DefaultNameAva[];
