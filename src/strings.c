...
const u8 gText_DefaultNameMohsen[] = _("Mohsen");
const u8 gText_DefaultNameSina[] = _("Sina");
const u8 gText_DefaultNameHossein[] = _("Hossein");
const u8 gText_DefaultNameAlireza[] = _("Alireza");
const u8 gText_DefaultNameSohrab[] = _("Sohrab");
const u8 gText_DefaultNameArmaan[] = _("Armaan");
const u8 gText_DefaultNameDariush[] = _("Dariush");
const u8 gText_DefaultNameFarzad[] = _("Farzad");
const u8 gText_DefaultNameMilad[] = _("Milad");
const u8 gText_DefaultNameNima[] = _("Nima");
const u8 gText_DefaultNameLeVeon[] = _("Le'Veon");
const u8 gText_DefaultNameNavid[] = _("Navid");
const u8 gText_DefaultNameOmid[] = _("Omid");
const u8 gText_DefaultNameAbbas[] = _("Abbas");
const u8 gText_DefaultNameKasey[] = _("Kasey");
const u8 gText_DefaultNameAsghar[] = _("Asghar");
const u8 gText_DefaultNameReza[] = _("Reza");
const u8 gText_DefaultNameSaeed[] = _("Saeed");
const u8 gText_DefaultNameAfshin[] = _("Afshin");
const u8 gText_DefaultNameSiavash[] = _("Siavash");
const u8 gText_DefaultNameParvin[] = _("Parvin");
const u8 gText_DefaultNameShila[] = _("Shila");
const u8 gText_DefaultNameMitra[] = _("Mitra");
const u8 gText_DefaultNameSima[] = _("Sima");
const u8 gText_DefaultNameParisa[] = _("Parisa");
const u8 gText_DefaultNameYosi[] = _("Yosi");
const u8 gText_DefaultNameShohreh[] = _("Shohreh");
const u8 gText_DefaultNameKimia[] = _("Kimia");
const u8 gText_DefaultNameBahar[] = _("Bahar");
const u8 gText_DefaultNameShadi[] = _("Shadi");
const u8 gText_DefaultNameMelody[] = _("Melody");
const u8 gText_DefaultNameShirin[] = _("Shirin");
const u8 gText_DefaultNameNazanin[] = _("Nazanin");
const u8 gText_DefaultNameNika[] = _("Nika");
const u8 gText_DefaultNameElaheh[] = _("Elaheh");
const u8 gText_DefaultNameNasrin[] = _("Nasrin");
const u8 gText_DefaultNameZahra[] = _("Zahra");
const u8 gText_DefaultNameNoushin[] = _("Noushin");
const u8 gText_DefaultNameSamira[] = _("Samira");
const u8 gText_DefaultNameAva[] = _("Ava");
