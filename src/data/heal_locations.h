static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NEW_BALTIMORE_CITY - 1] = {MAP_GROUP(NEW_BALTIMORE_CITY), MAP_NUM(NEW_BALTIMORE_CITY), 22, 32},
    [HEAL_LOCATION_NEW_BALTIMORE_CITY_NE - 1] = {MAP_GROUP(NEW_BALTIMORE_CITY_NE), MAP_NUM(NEW_BALTIMORE_CITY_NE), 15, 15},
};
