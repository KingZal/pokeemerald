...
static const u8 *const sMalePresetNames[] = {
    gText_DefaultNameMohsen,
    gText_DefaultNameSina,
    gText_DefaultNameHossein,
    gText_DefaultNameAlireza,
    gText_DefaultNameSohrab,
    gText_DefaultNameArmaan,
    gText_DefaultNameDariush,
    gText_DefaultNameFarzad,
    gText_DefaultNameMilad,
    gText_DefaultNameNima,
    gText_DefaultNameLeVeon,
    gText_DefaultNameNavid,
    gText_DefaultNameOmid,
    gText_DefaultNameAbbas,
    gText_DefaultNameKasey,
    gText_DefaultNameAsghar,
    gText_DefaultNameReza,
    gText_DefaultNameSaeed,
    gText_DefaultNameAfshin,
    gText_DefaultNameSiavash

};

static const u8 *const sFemalePresetNames[] = {
    gText_DefaultNameParvin,
    gText_DefaultNameShila,
    gText_DefaultNameMitra,
    gText_DefaultNameSima,
    gText_DefaultNameParisa,
    gText_DefaultNameYosi,
    gText_DefaultNameShohreh,
    gText_DefaultNameKimia,
    gText_DefaultNameBahar,
    gText_DefaultNameShadi,
    gText_DefaultNameMelody,
    gText_DefaultNameShirin,
    gText_DefaultNameNazanin,
    gText_DefaultNameNika,
    gText_DefaultNameElaheh,
    gText_DefaultNameNasrin,
    gText_DefaultNameZahra,
    gText_DefaultNameNoushin,
    gText_DefaultNameSamira,
    gText_DefaultNameAva
};
